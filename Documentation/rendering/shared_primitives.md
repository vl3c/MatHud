...
| `stroke_arc(center, radius, start_angle_rad, end_angle_rad, sweep_clockwise, stroke)` | Stroke an arc section with direction control (angles in radians). | Angle arcs |
