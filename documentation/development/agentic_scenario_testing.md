...
| I5 | Undo accounting: a batch with at least one undoable call adds exactly one undo entry, a batch with none adds zero, and a failed call adds none | K1 |
...
- Checks:
  ...
  - invariant I5: at most one undo entry added, and undoing it changes nothing visible
