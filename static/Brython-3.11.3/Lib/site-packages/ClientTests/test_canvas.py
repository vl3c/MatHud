...
class TestCanvas(unittest.TestCase):
    ...
    def test_split_segment_with_specific_coordinates(self):
        ...
        self.canvas._split_segments_with_point(point_c_x, point_c_y)
        ...
        is_point_on_segment = MathUtil.is_point_on_segment(
            c_pos.x, c_pos.y, 
            a_pos.x, a_pos.y, 
            b_pos.x, b_pos.y
        )
    ...
    def test_split_segment_comprehensive(self):
        ...
        self.canvas._split_segments_with_point(10, 0)
        ...
        self.canvas._split_segments_with_point(25, 0)
        ...
        cd_parents = self.canvas._get_segment_parents(cd_segment)
        db_parents = self.canvas._get_segment_parents(db_segment)
    ...
    def test_ellipse_rotation(self):
        ...
        self.assertEqual(ellipse.ellipse_formula, 
                        MathUtil.get_ellipse_formula(100, 100, 50, 30, 60))
    ...
    def test_ellipse_formula_after_rotation(self):
        ...
        self.assertEqual(ellipse.ellipse_formula,
                        MathUtil.get_ellipse_formula(100, 100, 50, 30, 45))
