...
class TestCanvas(unittest.TestCase):
    ...
    def test_get_segment_parents(self):
        ...
        self.canvas.create_point(10, 0)
        dm = self.canvas.drawable_manager.dependency_manager
        children = list(dm.get_children(segment))
        self.assertEqual(len(children), 2, "Segment should have 2 children.")
        parent1 = dm.get_parents(children[0])
        parent2 = dm.get_parents(children[1])
    ...
    def test_segment_preservation_with_multiple_points(self):
        ...
        children_ab = self.canvas.drawable_manager.dependency_manager.get_children(ab)
        self.assertEqual(len(children_ab), 9, "Original segment AB should have 9 children (all possible segments between points)")
        
        # Verify key segments are children
        self.assertIn(ac_segment, children_ab, "Segment AC should be a child of AB")
        self.assertIn(cd_segment, children_ab, "Segment CD should be a child of AB")
        self.assertIn(de_segment, children_ab, "Segment DE should be a child of AB")
        self.assertIn(eb_segment, children_ab, "Segment EB should be a child of AB")
