...
class ExpressionValidator(ast.NodeVisitor):
    ALLOWED_NODES = {ast.Add, ast.Sub, ast.Mult, ast.Div, ast.USub, ast.UAdd, ast.Constant, ast.Name, ast.BinOp, ast.UnaryOp, ast.Expression, ast.Call}
    ALLOWED_FUNCTIONS = {'sin', 'cos', 'tan', 'sqrt', 'log', 'log10', 'log2', 'factorial', 'asin', 'acos', 'atan', 'sinh', 'cosh', 'tanh', 'exp', 'abs', 'pi', 
                         'e', 'pow', 'det', 'bin', 'round', 'ceil', 'floor', 'trunc', 'max', 'min', 'sum', 'limit', 'derive', 'integrate', 
                         'simplify', 'expand', 'factor', 'solve', 'gcd', 'lcm', 'mean', 'median', 'mode', 'stdev', 'variance', 'random', 'randint'
    }
    ...
    def evaluate_expression(expression, x=0):
        ...
        variables_and_functions = {
            ...
            'derive': MathUtil.derivative, # Derivative of a function
