...
import json
import ClientTests.tests as tests
import traceback
from canvas import Canvas
from workspace_manager import save_workspace, load_workspace, list_workspaces
...
class AIInterface:
    ...
    def save_workspace(self, name=None):
        ...
        return save_workspace(self.canvas, name)

    def load_workspace(self, name=None):
        """Load a workspace state."""
        return load_workspace(self.canvas, name)
