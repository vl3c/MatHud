...
class AIInterface:
    ...
    def _parse_ai_response(self, ai_message, ai_function_calls, finish_reason):
        try:
            ...
            print(f"AI finish reason: {finish_reason}")   # DEBUG
    ...
    def _on_complete(self, request):
        if request.status == 200 or request.status == 0:
            ...
            if not response_json.get('data'):
                error_msg = response_json.get('message', 'Invalid response format')
            ...
            self._parse_ai_response(ai_message, ai_function_calls, finish_reason)
        else:
