...
class MathUtil:
    ...
    def determine_max_number_of_solutions(equations):
        try:
            ...
            # Print the equation types for debugging
            print(f"Equations: {equations}")
            print(f"Equation types: {equation_types}")
            ...
            if len(equations) == 1:
                ...
                return 4  # Two quadratic equations can intersect in up to 4 points
            elif linear_count == 2:
                return 1  # Two linear equations can intersect in at most 1 point
            elif linear_count == 1 and cubic_count == 1:
                return 3  # A cubic and a linear equation can intersect in up to 3 points
            elif quadratic_count == 1 and cubic_count == 1:
                return 3  # A quadratic and a cubic equation can intersect in up to 3 points
            elif quartic_count == 1 and linear_count == 1:
                return 4  # A quartic and a linear equation can intersect in up to 4 points
            # Add more combinations as needed
            else:
                return 0  # Default case for unhandled combinations
        except Exception as e:
            return f"Error: {e} {getattr(e, 'message', str(e))}"
