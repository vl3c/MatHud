...
class ExpressionValidator(ast.NodeVisitor):
    ...
    ALLOWED_FUNCTIONS = {
        'sin', 'cos', 'tan', 'sqrt', 'log', 'log10', 'log2', 'factorial', 'asin', 'acos', 'atan', 'sinh', 'cosh', 'tanh', 'exp', 'abs', 'pi', 'e', 'pow'
    }
...
class Utilities:
    ...
    @staticmethod
    def test_math_js():
        print("Testing math.js:")
        print(f"sqrt(16) = {window.math.sqrt(16)} // Expected: 4")
        print(f"pow(2, 3) = {window.math.pow(2, 3)} // Expected: 8")
        print(f"abs(-10) = {window.math.abs(-10)} // Expected: 10")
        print(f"sin(pi/2) = {window.math.sin(window.math.pi / 2)} // Expected: 1")
        print(f"cos(pi) = {window.math.cos(window.math.pi)} // Expected: -1")
        print(f"tan(pi/4) = {window.math.tan(window.math.pi / 4)} // Expected: 1")
        print(f"round(e, 3) = {window.math.round(window.math.e, 3)} // Expected: 2.718")
        print(f"atan2(3, -3) / pi = {window.math.atan2(3, -3) / window.math.pi} // Expected: 0.75")
        print(f"log(10000, 10) = {window.math.log(10000, 10)} // Expected: 4")
