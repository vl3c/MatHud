...
class MathUtil:
    ...
    def calculate_vertical_asymptotes(function_string, left_bound=None, right_bound=None):
        ...
        if '/' in function_string:
            ...
            try:
                ...
                zeros = json.loads(MathUtil.solve(denominator, 'x'))
    ...
    def calculate_horizontal_asymptotes(function_string):
        ...
        try:
            ...
            limit_inf = float(MathUtil.limit(function_string, 'x', 'inf'))
        ...
        try:
            ...
            limit_neg_inf = float(MathUtil.limit(function_string, 'x', '-inf'))
    ...
    @staticmethod
    def calculate_asymptotes(function_string, left_bound=None, right_bound=None):
        """Calculate both vertical and horizontal asymptotes of a function"""
        from expression_validator import ExpressionValidator
        
        # Standardize the function string
        function_string = ExpressionValidator.fix_math_expression(function_string)
        vertical_asymptotes = MathUtil.calculate_vertical_asymptotes(function_string, left_bound, right_bound)
        horizontal_asymptotes = MathUtil.calculate_horizontal_asymptotes(function_string)
