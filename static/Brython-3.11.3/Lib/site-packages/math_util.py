...
class Utilities:
    ...
    def parse_function_string(function_string):       
        function_string = Utilities.fix_math_expression(function_string)
    ...
    def evaluate_expression(expression):
        expression = Utilities.fix_math_expression(expression)
    ...
    def test_math_functions():
        ...
        print(f"random() = {Utilities.random()} // Expected: a random number between 0 and 1")
        print(f"round(1.2345, 2) = {Utilities.round(1.2345, 2)} // Expected: 1.23")
        print(f"gcd(48, 18) = {Utilities.gcd(48, 18)} // Expected: 6")
        print(f"lcm(4, 5) = {Utilities.lcm(4, 5)} // Expected: 20")
        print(f"mean(1, 2, 3, 4, 5) = {Utilities.mean([1, 2, 3, 4, 5])} // Expected: 3")
        print(f"median(1, 2, 3, 4, 5) = {Utilities.median([1, 2, 3, 4, 5])} // Expected: 3")
        print(f"mode(1, 2, 2, 3) = {Utilities.mode([1, 2, 2, 3])} // Expected: 2")
        print(f"stdev([2, 4, 6, 8, 10]) = {Utilities.stdev([2, 4, 6, 8, 10])} // Expected: 3.1623")
        print(f"variance([2, 4, 6, 8, 10]) = {Utilities.variance([2.75, 1.75, 1.25, 0.25, 0.5, 1.25, 3.5])} // Expected: 1.372")
        print(f"limit('sin(x) / x', 'x', 0) = {Utilities.limit('sin(x) / x', 'x', 0)} // Expected: 1")
        print(f"derivative('x^2', 'x') = {Utilities.derivative('x^2', 'x')} // Expected: 2 * x")
        print(f"integral_indefinite('x^2', 'x') = {Utilities.integral_indefinite('x^2', 'x')} // Expected: x^3/3")
        print(f"integral('x^2', 'x', 0, 1) = {Utilities.integral('x^2', 'x', 0, 1)} // Expected: 0.333")
        print(f"simplify('x^2 + 2*x + 1') = {Utilities.simplify('x^2 + 2*x + 1')} // Expected: (1+x)^2")
        print(f"expand('(x + 1)^2') = {Utilities.expand('(x + 1)^2')} // Expected: 1 + 2*x + x^2")
        print(f"factor('x^2 - 1') = {Utilities.factor('x^2 - 1')} // Expected: (x - 1)*(x + 1)")
        print(f"solve('x^2 - 4', 'x') = {Utilities.solve('x^2 - 4', 'x')} // Expected: [-2, 2]")
        print(f"roots('x^2 - 9') = {Utilities.roots('x^2 - 9')} // Expected: [-3, 3]")
        print(f"solve_system_of_equations(['x + y = 4', 'x - y = 2']) = {Utilities.solve_system_of_equations(['x + y = 4', 'x - y = 2'])} // Expected: x=3, y=1")
