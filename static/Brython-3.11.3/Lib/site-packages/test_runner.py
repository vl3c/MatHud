...
class TestRunner:
    ...
    def _get_graphics_test_function_calls(self):
        ...
        return [
            ...
            {
                "function_name": "create_angle_by_points",
                "arguments": {"vx": 50, "vy": 50, "p1x": 150, "p1y": 50, "p2x": 50, "p2y": 150, "label": "Angle_90deg", "color": "red"}
            },
            {
                "function_name": "create_angle_by_points",
                "arguments": {"vx": 200, "vy": 200, "p1x": 300, "p1y": 200, "p2x": 300, "p2y": 300, "label": "Angle_45deg", "color": "blue"}
            },
            {
                "function_name": "create_angle_by_points",
                # Vertex (350,50), Arm1 (450,50), Arm2 (350,150) -> should be 270 degrees (or -90)
                "arguments": {"vx": 350, "vy": 150, "p1x": 450, "p1y": 150, "p2x": 350, "p2y": 50, "label": "Angle_270deg", "color": "green"}
            },
            {
