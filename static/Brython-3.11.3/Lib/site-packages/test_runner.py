    ...
    def _get_graphics_test_function_calls(self):
        ...
        return [
            ...
            },
            {
                ...
                "arguments": {"vx": 50, "vy": 50, "p1x": 150, "p1y": 50, "p2x": 50, "p2y": 150, "color": "red", "angle_name": None}
            },
            {
                "function_name": "create_angle_by_points",
                "arguments": {"vx": 200, "vy": 200, "p1x": 300, "p1y": 200, "p2x": 300, "p2y": 300, "color": "blue", "angle_name": None}
            },
            {
                "function_name": "create_angle_by_points",
                # Vertex (350,50), Arm1 (450,50), Arm2 (350,150) -> should be 270 degrees (or -90)
                "arguments": {"vx": 350, "vy": 150, "p1x": 450, "p1y": 150, "p2x": 350, "p2y": 50, "color": "green", "angle_name": None}
            },
            {
