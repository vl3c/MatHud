...
class ResultProcessor:
    ...
    def get_results(calls, available_functions, undoable_functions, canvas):
        ...
        non_computation_functions = unformattable_functions + ('list_workspaces', 'save_workspace', 'load_workspace', 'delete_workspace')  # Functions that shouldn't be added to computations
