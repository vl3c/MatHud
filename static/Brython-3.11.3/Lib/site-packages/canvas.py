...
class Canvas:
    ...
    def create_point(self, x, y, name="", archive_state=True, extra_graphics=True):
    ...
    def create_segment(self, x1, y1, x2, y2, name="", archive_state=True, extra_graphics=True):
        ...
        p1 = self.create_point(x1, y1, archive_state=False, extra_graphics=False)
        p2 = self.create_point(x2, y2, archive_state=False, extra_graphics=False)
    ...
    def create_vector(self, origin_x, origin_y, tip_x, tip_y, name="", archive_state=True, extra_graphics=True):
        ...
        if archive_state:
            self.archive()
        #point_names = self.name_generator.split_in_n_point_names(name, 2)
        origin = self.create_point(origin_x, origin_y, archive_state=False, extra_graphics=False)
        tip = self.create_point(tip_x, tip_y, archive_state=False, extra_graphics=False)
    ...
    def create_triangle(self, x1, y1, x2, y2, x3, y3, name="", archive_state=True, extra_graphics=True):
        existing_triangle = self.get_triangle(x1, y1, x2, y2, x3, y3)
        if existing_triangle:
            return existing_triangle
        if archive_state:
            self.archive()
        s1 = self.create_segment(x1, y1, x2, y2, archive_state=False, extra_graphics=False)
        s2 = self.create_segment(x2, y2, x3, y3, archive_state=False, extra_graphics=False)
        s3 = self.create_segment(x3, y3, x1, y1, archive_state=False, extra_graphics=False)
    ...
    def create_rectangle(self, diagonal_p1_x, diagonal_p1_y, diagonal_p2_x, diagonal_p2_y, name="", archive_state=True, extra_graphics=True):
        # Check if the rectangle already exists
        existing_rectangle = self.get_rectangle_by_diagonal_points(diagonal_p1_x, diagonal_p1_y, diagonal_p2_x, diagonal_p2_y)
        if existing_rectangle:
            return existing_rectangle
        if archive_state:
            self.archive()
        # Create or retrieve the segments of the rectangle
        s1 = self.create_segment(diagonal_p1_x, diagonal_p1_y, diagonal_p2_x, diagonal_p1_y, archive_state=False, extra_graphics=False)
        s2 = self.create_segment(diagonal_p2_x, diagonal_p1_y, diagonal_p2_x, diagonal_p2_y, archive_state=False, extra_graphics=False)
        s3 = self.create_segment(diagonal_p2_x, diagonal_p2_y, diagonal_p1_x, diagonal_p2_y, archive_state=False, extra_graphics=False)
        s4 = self.create_segment(diagonal_p1_x, diagonal_p2_y, diagonal_p1_x, diagonal_p1_y, archive_state=False, extra_graphics=False)
    ...
    def create_circle(self, center_x, center_y, radius, name="", archive_state=True, extra_graphics=True):
        existing_circle = self.get_circle(center_x, center_y, radius)
        if existing_circle:
            return existing_circle
        if archive_state:
            self.archive()
        center = self.create_point(center_x, center_y, archive_state=False, extra_graphics=False)
    ...
    def create_ellipse(self, center_x, center_y, radius_x, radius_y, name="", archive_state=True, extra_graphics=True):
        ...
        if archive_state:
            self.archive()
        center = self.create_point(center_x, center_y, archive_state=False, extra_graphics=False)
        ellipse = Ellipse(center, radius_x, radius_y, canvas=self)
                ...
                for k in range(j+1, len(segments)):
                    ...
                    if len(unique_points) == 3 and self._are_points_connected(unique_points):
                        ...
                        self.create_triangle(p1.original_position.x, p1.original_position.y, 
                                             ...
                                             archive_state=False, extra_graphics=False)
        ...
        for segment in segments.copy():
            ...
            if Utilities.is_point_on_segment(x, y, sp1.x, sp1.y, sp2.x, sp2.y):
                ...
                if (x, y) != (sp1.x, sp1.y) and (x, y) != (sp2.x, sp2.y):
                    ...
                    new_point = self.create_point(x, y, archive_state=False, extra_graphics=False)
                    # Create new segments
                    segment1 = self.create_segment(new_point.original_position.x, new_point.original_position.y, sp1.x, sp1.y, archive_state=False, extra_graphics=False) 
                    segment2 = self.create_segment(new_point.original_position.x, new_point.original_position.y, sp2.x, sp2.y, archive_state=False, extra_graphics=False)
