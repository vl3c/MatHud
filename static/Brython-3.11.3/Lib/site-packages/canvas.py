...
class Canvas:
    ...
    def create_angle_by_points(self, vx, vy, p1x, p1y, p2x, p2y, color=None, angle_name=None, is_reflex: bool = False):
        ...
        if self.drawable_manager.angle_manager:
            return self.drawable_manager.angle_manager.create_angle(
                ...
                color=color, angle_name=angle_name, is_reflex=is_reflex
            )
        return None
    ...
    def remove_angle(self, name):
        ...
        if self.drawable_manager.angle_manager:
            return self.drawable_manager.angle_manager.remove_angle(name)
        return False
