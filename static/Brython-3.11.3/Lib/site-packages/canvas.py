...
class Canvas:
    ...
    def create_rectangle(self, diagonal_p1_x, diagonal_p1_y, diagonal_p2_x, diagonal_p2_y, name="", extra_graphics=True):
        ...
        s1 = self.create_segment(diagonal_p1_x, diagonal_p1_y, diagonal_p2_x, diagonal_p1_y, extra_graphics=False)
        s2 = self.create_segment(diagonal_p2_x, diagonal_p1_y, diagonal_p2_x, diagonal_p2_y, extra_graphics=False)
        s3 = self.create_segment(diagonal_p2_x, diagonal_p2_y, diagonal_p1_x, diagonal_p2_y, extra_graphics=False)
        s4 = self.create_segment(diagonal_p1_x, diagonal_p2_y, diagonal_p1_x, diagonal_p1_y, extra_graphics=False)
                ...
                for k in range(j+1, len(segments)):
                    ...
                    if len(unique_points) == 3 and self._are_points_connected(unique_points):
                        ...
                        self.create_triangle(p1.original_position.x, p1.original_position.y, 
                                             ...
                                             p3.original_position.x, p3.original_position.y, extra_graphics=False)
        ...
        for segment in segments.copy():
            ...
            if Utilities.is_point_on_segment(x, y, sp1.x, sp1.y, sp2.x, sp2.y):
                ...
                if (x, y) != (sp1.x, sp1.y) and (x, y) != (sp2.x, sp2.y):
                    ...
                    # Create new segments
                    segment1 = self.create_segment(new_point.original_position.x, new_point.original_position.y, sp1.x, sp1.y, extra_graphics=False) 
                    segment2 = self.create_segment(new_point.original_position.x, new_point.original_position.y, sp2.x, sp2.y, extra_graphics=False)
