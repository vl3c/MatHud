...
class Canvas:
    def __init__(self):
        ...
        self.cartesian2axis.origin = Point(0, 0, self)
    ...
    def delete_point(self, x, y):
        for drawable in self.drawables:
            if drawable.class_name() == 'Point' and drawable.x == x and drawable.y == y:
...
class Label(Drawable):
    def __init__(self, position, text, canvas, color=default_color, font_size=default_font_size):
        self.origin = Point(position['x'], position['y'], color=color, canvas=canvas)
        self.text = text
    ...
    def get_state(self):
        ...
        state = {"class": self.class_name, "args": {"position": {"x": pos.x, "y": pos.y}, "text": self.text}}
        return state
...
class Cartesian2Axis(Drawable):
    ...
    def get_state(self):
        state = {"class": self.class_name, "args": {"width": self.width, "height": self.height, "tick_spacing": self.tick_spacing}}
        return state