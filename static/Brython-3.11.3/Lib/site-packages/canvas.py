...
class Canvas:
    ...
    def create_angle_by_points(self, vx, vy, p1x, p1y, p2x, p2y, label=None, color=None, angle_name=None):
        """Creates an angle defined by three points by delegating to DrawableManager."""
        return self.drawable_manager.create_angle_by_points(
            vx, vy, p1x, p1y, p2x, p2y, 
            label=label, color=color, angle_name=angle_name
        )

    def remove_angle(self, name):
        """Removes an angle by its name by delegating to DrawableManager."""
        return self.drawable_manager.remove_angle(name)

    def update_angle_properties(self, name, new_label=None, new_color=None):
        """Updates the label and/or color of an existing angle by delegating to DrawableManager."""
        return self.drawable_manager.update_angle_properties(name, new_label, new_color)
