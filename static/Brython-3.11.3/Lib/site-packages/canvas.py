...
class Canvas:
    ...
    def draw_math_function(self, function_string, name, left_bound=None, right_bound=None, archive_state=True):
        ...
        if existing_function:
            ...
            existing_function.function_string = MathUtil.fix_math_expression(function_string)
            try:
                existing_function.function = MathUtil.parse_function_string(function_string)
