...
class Canvas:
    ...
    def get_drawables_by_class_name(self, class_name):
        ...
        return self.drawable_manager.get_drawables_by_class_name(class_name)
    ...
    def is_point_within_canvas_visible_area(self, x, y):
        ...
        return self.drawable_manager.is_point_within_canvas_visible_area(x, y)
    ...
    def any_segment_part_visible_in_canvas_area(self, x1, y1, x2, y2):
        ...
        return self.drawable_manager.any_segment_part_visible_in_canvas_area(x1, y1, x2, y2)
