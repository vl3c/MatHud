...
class Canvas:
    ...
    def any_segment_part_visible_in_canvas_area(self, x1, y1, x2, y2):
        print(f"Segment endpoints: ({x1}, {y1}), ({x2}, {y2})")
        ...
        print(f"Intersects with top: {intersect_top}")
        print(f"Intersects with right: {intersect_right}")
        print(f"Intersects with bottom: {intersect_bottom}")
        print(f"Intersects with left: {intersect_left}")
