...
class Canvas:
    ...
    def create_segment(self, x1, y1, x2, y2, name=""):
        ...
        p1 = self.create_point(x1, y1, point_names[0])
        p2 = self.create_point(x2, y2, point_names[1])
    ...
    def create_vector(self, origin_x, origin_y, tip_x, tip_y, name=""):
        ...
        self.archive()
        point_names = self.name_generator.split_in_n_point_names(name, 2)
        origin = self.create_point(origin_x, origin_y, point_names[0])
        tip = self.create_point(tip_x, tip_y, point_names[1])
    ...
    def create_triangle(self, x1, y1, x2, y2, x3, y3, name=""):
        ...
        self.archive()
        s1= self.create_segment(x1, y1, x2, y2)
        s2= self.create_segment(x2, y2, x3, y3)
        s3= self.create_segment(x3, y3, x1, y1)
    ...
    def create_rectangle(self, diag_p1_x, diag_p1_y, diag_p2_x, diag_p2_y):
        ...
        s1 = self.create_segment(diag_p1_x, diag_p1_y, diag_p2_x, diag_p1_y)
        s2 = self.create_segment(diag_p2_x, diag_p1_y, diag_p2_x, diag_p2_y)
        s3 = self.create_segment(diag_p2_x, diag_p2_y, diag_p1_x, diag_p2_y)
        s4 = self.create_segment(diag_p1_x, diag_p2_y, diag_p1_x, diag_p1_y)
        ...
        for segment in segments.copy():
            ...
            if Utilities.is_point_on_segment(x, y, sp1.x, sp1.y, sp2.x, sp2.y):
                ...
                if (x, y) != (sp1.x, sp1.y) and (x, y) != (sp2.x, sp2.y):
                    ...
                    # Create new segments
                    segment1 = Segment(new_point, sp1, canvas=self)
                    segment2 = Segment(new_point, sp2, canvas=self)
