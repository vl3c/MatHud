...
class MathUtils:
    ...
    def triangle_matches_coordinates(triangle, x1, y1, x2, y2, x3, y3):
        ...
        """
        # Get the coordinates from the triangle's points
        p1 = triangle.point1.original_position
        p2 = triangle.point2.original_position
        p3 = triangle.point3.original_position
        
        # Create sets of coordinates for comparison
        triangle_points = {(p1.x, p1.y), (p2.x, p2.y), (p3.x, p3.y)}
        check_points = {(x1, y1), (x2, y2), (x3, y3)}
        
        # Check if they are the same points (order doesn't matter)
        return triangle_points == check_points
