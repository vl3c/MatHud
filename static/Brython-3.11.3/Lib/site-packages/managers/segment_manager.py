        ...
        if delete_parents:
            ...
            for parent in list(parents_to_delete):
                if hasattr(parent, 'point1') and hasattr(parent, 'point2'):
                    # Recursively call delete_segment for the parent
                    # Ensure we don't try to delete children of the parent in this recursive call
                    self.delete_segment(parent.point1.original_position.x, parent.point1.original_position.y,
                                          ...
                                          delete_children=False, delete_parents=True)
                else:
