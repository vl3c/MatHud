...
class UndoRedoManager:
    ...
    def archive(self):
        ...
        """
        archived_state = {
            'drawables': copy.deepcopy(self.canvas.drawables),
    ...
    def undo(self):
        ...
        self.canvas.drawables = copy.deepcopy(last_state['drawables'])
    ...
    def redo(self):
        ...
        self.canvas.drawables = copy.deepcopy(next_state['drawables'])
    ...
    def _fix_drawable_canvas_references(self):
        ...
        for drawable_type in self.canvas.drawables:
            for drawable in self.canvas.drawables[drawable_type]:
