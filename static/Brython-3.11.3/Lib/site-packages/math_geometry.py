...
class Segment(Drawable):
    ...
    def _scale(self, factor):
        ...
        center_coord = Utilities.get_2D_midpoint(self.point1, self.point2)
        center = Point(center_coord[0], center_coord[1])
...
class Triangle(Drawable):
    ...
    def _scale(self, factor):
        ...
        self._translate(Point(-centroid.x, -centroid.y))
        # Scale
...
class Rectangle(Drawable):
    ...
    def _scale(self, factor):
        ...
        self.top_left._translate(Point(-center_x, -center_y))
        self.top_left._scale_coordinates(factor)
        self.top_left._translate(Point(center_x, center_y))
        self.bottom_right._translate(Point(-center_x, -center_y))
