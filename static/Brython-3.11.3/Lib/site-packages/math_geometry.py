...
class Segment(Drawable):
    ...
    def _create_points(self, x1, y1, x2, y2, canvas, name, color):
        p_names = canvas.name_generator.split_in_2_point_names(name)
    ...
    def get_state(self):
        ...
        state = {"name": self.name, "args": {"p1_name": points_names[0], "p2_name": points_names[1]}}
        return state
...
class Triangle(Drawable):
    ...
    def _create_segments(self, x1, y1, x2, y2, x3, y3, canvas, name, color):
        point_names = canvas.name_generator.split_in_3_point_names(name)
    ...
    def get_state(self):
        ...
        state = {"name": self.name, "args": {"point_1_name": points_names[0], "point_2_name": points_names[1], "point_3_name": points_names[2]}}
        return state
...
class Rectangle(Drawable):
    ...
    def get_state(self):
        ...
        state = {"name": self.name, "args": {"top_left": {"x": top_left.x, "y": top_left.y}, "bottom_right": {"x": bottom_right.x, "y": bottom_right.y}}}
        return state
