...
class Segment(Drawable):
    ...
    def get_state(self):
        ...
        state = {"class": self.class_name, "args": {"point1": {"x": p1.x, "y": p1.y}, "point2": {"x": p2.x, "y": p2.y}}}
        return state
...
class Triangle(Drawable):
    ...
    def get_state(self):
        ...
        state = {"class": self.class_name, "args": {"point1": {"x": p1.x, "y": p1.y}, "point2": {"x": p2.x, "y": p2.y}, "point3": {"x": p3.x, "y": p3.y}}}
        return state
...
class Rectangle(Drawable):
    ...
    def get_state(self):
        ...
        state = {"class": self.class_name, "args": {"top_left": {"x": top_left.x, "y": top_left.y}, "bottom_right": {"x": bottom_right.x, "y": bottom_right.y}}}
        return state
...
class Circle(Drawable):
    ...
    def get_state(self):
        ...
        state = {"class": self.class_name, "args": {"center_point": {"x": center.x, "y": center.y}, "radius": radius}}
        return state
...
class Ellipse(Drawable):
    ...
    def get_state(self):
        ...
        ry = self.original_ry
        center = self.center.original_position
        state = {"class": self.class_name, "args": {"center_point": {"x": center.x, "y": center.y}, "radius_x": rx, "radius_y": ry}}
        return state
...
class Vector(Drawable):
    ...
    def get_state(self):
        ...
        state = {"class": self.class_name, "args": {"origin": {"x": origin.x, "y": origin.y}, "tip": {"x": tip.x, "y": tip.y}}}
        return state
...
class Function(Drawable):
    ...
    def get_state(self):
        ...
        state = {"class": self.class_name, "args": {"function_string": function_string, "start": {"x": start.x, "y": start.y}, "end": {"x": end.x, "y": end.y}}}
        return state