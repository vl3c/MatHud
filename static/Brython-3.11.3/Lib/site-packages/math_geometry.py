...
class Triangle(Drawable):
    def __init__(self, segment1, segment2, segment3, canvas, color=default_color):
        ...
        point_names = [segment1.point1.name, segment1.point2.name, segment2.point2.name]
        name = canvas.name_generator.get_unique_triangle_name_from_point_names(*point_names)
        super().__init__(name=name, color=color, canvas=canvas)
        self._initialize()
...
class Rectangle(Drawable):
    def __init__(self, segment1, segment2, segment3, segment4, canvas, color=default_color):
        ...
        point_names = [segment1.point1.name, segment1.point2.name, segment2.point2.name, segment3.point2.name]
        name = canvas.name_generator.get_unique_rectangle_name_from_point_names(*point_names)
        super().__init__(name=name, color=color, canvas=canvas)
        self._initialize()
...
class Circle(Drawable):
    def __init__(self, center_point, radius, canvas, name="", color=default_color):
        self.radius = radius
    ...
    def __deepcopy__(self, memo):
        ...
        new_circle = Circle(new_center, self.original_radius, canvas=self.canvas, name=self.name, color=self.color)
        memo[id(self)] = new_circle
        return new_circle


class Ellipse(Drawable):
    def __init__(self, center_point, radius_x, radius_y, canvas, name="", color=default_color):
    ...
    def __deepcopy__(self, memo):
        ...
        new_ellipse = Ellipse(new_center, self.radius_x, self.radius_y, canvas=self.canvas, name=self.name, color=self.color)
