...
class Segment(Drawable):
    def __init__(self, point1, point2, name="", color=default_color, canvas=None):
        self.name = name
        self.point1 = Point(point1['x'], point1['y'], canvas=canvas, name=f"{name}-segment-point1", color=color)
        self.point2 = Point(point2['x'], point2['y'], canvas=canvas, name=f"{name}-segment-point2", color=color)
        super().__init__(name=name, color=color, canvas=canvas)
        self._initialize()
    
    @classmethod
    def from_points(cls, point1, point2, name="", color=default_color, canvas=None):
        dict_point1 = {"x": point1.x, "y": point1.y}
        dict_point2 = {"x": point2.x, "y": point2.y}
        return cls(dict_point1, dict_point2, name, color, canvas)
    
    @classmethod
    def from_coordinates(cls, x1, y1, x2, y2, name="", color=default_color, canvas=None):
        dict_point1 = {"x": x1, "y": y1}
        dict_point2 = {"x": x2, "y": y2}
        return cls(dict_point1, dict_point2, name, color, canvas)
...
class Triangle(Drawable):
    def __init__(self, point1, point2, point3, name="", color=default_color, canvas=None):
        self.name = name
...
class Vector(Drawable):
    def __init__(self, origin, tip, name="", color=default_color, canvas=None):
        self.name = name
        self.segment = Segment(origin, tip, name=f"{name}-vector-segment", color=color, canvas=canvas)
        super().__init__(name=name, color=color, canvas=canvas)
        self._initialize()
