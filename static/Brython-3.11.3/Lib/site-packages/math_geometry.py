...
class Segment(Drawable):
    ...
    def _calculate_line_algebraic_formula(self):
        p1 = self.point1
        p2 = self.point2
        line_formula = MathUtil.calculate_line_formula(p1.original_position.x, p1.original_position.y, p2.original_position.x, p2.original_position.y)
        return line_formula
...
class Circle(Drawable):
    ...
    def _calculate_circle_algebraic_formula(self):
        ...
        r = self.radius
        circle_formula = MathUtil.calculate_circle_formula(x, y, r)
...
class Ellipse(Drawable):
    ...
    def _calculate_ellipse_algebraic_formula(self):
        ...
        rx = self.radius_x
        ry = self.radius_y
        ellipse_formula = MathUtil.calculate_ellipse_formula(x, y, rx, ry)
...
class Function(Drawable):
    def __init__(self, function_string, canvas, name, step=default_point_size, color=default_color, left_bound=None, right_bound=None):
        self.step = step
        self.function_string = MathUtil.fix_math_expression(function_string)
        self.left_bound = left_bound
        self.right_bound = right_bound
        try:
            self.function = MathUtil.parse_function_string(function_string)
