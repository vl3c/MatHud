...
class Triangle(Drawable):
    ...
    def get_state(self):
        ...
        state = {"name": self.name, "args": {"p1": points_names[0], "p2": points_names[1], "p3": points_names[2]}}
        return state


class Rectangle(Drawable):
    def __init__(self, diag_point_x, diag_point_y, opposite_diag_point_x, opposite_diag_point_y, canvas, name="", color=default_color):
        self._create_segments(diag_point_x, 
                              diag_point_y, 
                              opposite_diag_point_x, 
                              diag_point_y, 
                              opposite_diag_point_x, 
                              opposite_diag_point_y, 
                              diag_point_x, 
                              opposite_diag_point_y, 
                              canvas, 
                              name, 
...
class Circle(Drawable):
    ...
    def get_state(self):
        ...
        state = {"name": self.name, "args": {"center_point": {"x": center.x, "y": center.y}, "radius": radius}}
        return state
...
class Ellipse(Drawable):
    ...
    def get_state(self):
        ...
        ry = self.original_ry
        center = self.center.original_position
        state = {"name": self.name, "args": {"center_point": {"x": center.x, "y": center.y}, "radius_x": rx, "radius_y": ry}}
        return state
...
class Vector(Drawable):
    ...
    def get_state(self):
        ...
        state = {"name": self.name, "args": {"origin": {"x": origin.x, "y": origin.y}, "tip": {"x": tip.x, "y": tip.y}}}
        return state
