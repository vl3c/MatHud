...
class Function(Drawable):
    def __init__(self, function_string, canvas, name="", step=default_point_size, color=default_color):
    ...
    def _generate_values(self):
        ...
        left_bound = self.canvas.cartesian2axis.get_visible_left_bound()
        right_bound = self.canvas.cartesian2axis.get_visible_right_bound()
