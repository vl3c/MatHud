...
class Rectangle(Drawable):
    def __init__(self, segment1, segment2, segment3, segment4, canvas, color=default_color):
        ...
        if MathUtil.is_rectangle(segment1.point1.x, segment1.point1.y, segment2.point1.x, segment2.point1.y,
                                           segment3.point1.x, segment3.point1.y, segment4.point1.x, segment4.point1.y):
