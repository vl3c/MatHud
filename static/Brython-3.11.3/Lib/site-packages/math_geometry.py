...
class Segment(Drawable):
    ...
    def _create_points(self, x1, y1, x2, y2, canvas, name, color):
        p_names = canvas.name_generator.split_name_in2(name)
    ...
    def get_state(self):
        p1 = self.point1
        p2 = self.point2
        state = {"name": p1.name + p2.name, "args": {"p1_name": p1.name, "p2_name": p2.name}}
        return state
...
class Triangle(Drawable):
    ...
    def get_state(self):
        ...
        state = {"name": self.name, "args": {"point1": {"x": p1.x, "y": p1.y}, "point2": {"x": p2.x, "y": p2.y}, "point3": {"x": p3.x, "y": p3.y}}}
        return state
