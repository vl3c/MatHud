...
class Segment(Drawable):
    ...
    def __hash__(self):
        """Computes hash based on a frozenset of the endpoints' IDs."""
        ...
        # Use frozenset of ids to ensure hash is consistent regardless of point1/point2 order
        return hash(frozenset([id(self.point1), id(self.point2)])) 