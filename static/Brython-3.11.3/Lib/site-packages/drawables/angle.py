...
class Angle(Drawable):
    def __init__(self, segment1, segment2, canvas, color=DEFAULT_ANGLE_COLOR):
        """
        ...
        self.drawn_arc_radius = DEFAULT_ANGLE_ARC_SCREEN_RADIUS # Fixed screen radius from constants
    ...
    def from_state(cls, state_data, canvas):
        ...
        return cls(
            ...
            color=args.get("color", DEFAULT_ANGLE_COLOR) # Use constant for fallback color
        )
