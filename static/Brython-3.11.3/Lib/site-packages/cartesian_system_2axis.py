...
class Cartesian2Axis(Drawable):
    ...
    def get_state(self):
        state = {"Cartesian_System_Visibility": {"left_bound": self.get_visible_left_bound(), "right_bound": self.get_visible_right_bound(), 
                                    "top_bound": self.get_visible_top_bound(), "bottom_bound": self.get_visible_bottom_bound()}}
        return state