...
class Point(Drawable):
    def __init__(self, x, y, canvas, name="", color=default_color):
        name = canvas.name_generator.get_unique_point_name(name)
    ...
    def draw(self):
        ...
        self.create_svg_element('text', x=str(x+label_offset), y=str(y-label_offset), fill=self.color, text_content=label_text, text_font_size=default_font_size*5/8)
