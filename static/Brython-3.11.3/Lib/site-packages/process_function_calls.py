...
class ProcessFunctionCalls:
    ...
    def get_results(calls, available_functions, undoable_functions, canvas):
        ...
        ai_requested_intermediate_results = False
        ...
        for call in calls:
            try:
                ...
                if function_name not in available_functions:
                    ...
                    continue
                if function_name == 'request_results':
                    ai_requested_intermediate_results = True
                    continue
                ...
                if 'key' not in locals() or key is None:
                    key = "Unknown function call"
                # Store the error message as the value with the uniform key format
                results[key] = f"Error: {str(e)}"
        return results, ai_requested_intermediate_results
    ...
    def validate_results(results):
        ...
        return all(k and isinstance(k, str) and isinstance(v, allowed_types) for k, v in results.items())