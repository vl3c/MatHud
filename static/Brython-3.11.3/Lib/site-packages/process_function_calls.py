...
class ProcessFunctionCalls:
    ...
    def get_results(calls, available_functions, undoable_functions, canvas):
        ...
        unformattable_functions = undoable_functions + ('undo', 'redo', 'run_tests', 'save_workspace')
        non_computation_functions = unformattable_functions + ('list_workspaces', 'load_workspace')  # Functions that shouldn't be added to computations
