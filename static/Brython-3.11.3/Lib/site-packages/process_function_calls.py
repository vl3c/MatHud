        ...
        for call in calls:
            try:
                ...
                if function_name == 'evaluate_expression' and 'expression' in args:
                    ...
                    expression_and_result = f"{result} for {args['expression'].replace(' ', '')}{variables}"
                    ...
                    expression_and_result = f"{result} for {function_name}({formatted_args})"
                    expression_and_result = expression_and_result.replace('expression:', '')
