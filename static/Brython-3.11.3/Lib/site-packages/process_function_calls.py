...
class ProcessFunctionCalls:
    ...
    @staticmethod
    def set_function_call_result(value, results):
        # Modify function_call_results passed by reference
        results.clear()
        # Validate and update the list if valid
        if ProcessFunctionCalls.validate_results(value):
