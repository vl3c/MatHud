...
class TestCanvas(unittest.TestCase):
    ...
    def test_create_point_custom_name(self):
        # Basic cases
        ...
        # Advanced cases with apostrophes
        # Test point with apostrophes in name
        point4 = self.canvas.create_point(40, 40, "TR'IA'NG'LE")
        self.assertEqual(point4.name, "T")
        point5 = self.canvas.create_point(50, 50, "TR'IA'NG'LE")
        self.assertEqual(point5.name, "R'")

        # Test point with multiple consecutive apostrophes
        point6 = self.canvas.create_point(60, 60, "A''B'''C")
        self.assertEqual(point6.name, "A''")
        point7 = self.canvas.create_point(70, 70, "A''B'''C")
        self.assertEqual(point7.name, "B'''")

    def test_create_segment_custom_name(self):
        # Basic cases
        ...
        segment3 = self.canvas.create_segment(50, 50, 60, 60, "A'B''")
        self.assertEqual(segment3.point1.name, "A'")
        self.assertEqual(segment3.point2.name, "B''")
        # Test segment with mixed apostrophes
        segment4 = self.canvas.create_segment(70, 70, 80, 80, "X'Y")
        self.assertEqual(segment4.point1.name, "X'")
        self.assertEqual(segment4.point2.name, "Y")

    def test_create_triangle_custom_name(self):
        # Basic cases
        ...
        triangle3 = self.canvas.create_triangle(70, 70, 80, 80, 90, 90, "A'B''C'''")
        self.assertEqual(triangle3.segment1.point1.name, "A'")
        self.assertEqual(triangle3.segment1.point2.name, "B''")
        self.assertEqual(triangle3.segment2.point2.name, "C'''")

    def test_create_rectangle_custom_name(self):
        # Basic cases
        ...
        rectangle3 = self.canvas.create_rectangle(70, 70, 90, 90, "W'X''Y'''Z")
        points3 = [
            rectangle3.segment1.point1.name,
            rectangle3.segment1.point2.name,
            rectangle3.segment2.point2.name,
            rectangle3.segment3.point2.name
        ]
        # Check that the points use the letters with their apostrophes
        self.assertIn("W'", points3)
        self.assertIn("X''", points3)
        self.assertIn("Y'''", points3)
        self.assertIn("Z", points3)
