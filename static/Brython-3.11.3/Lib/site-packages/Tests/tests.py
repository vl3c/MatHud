...
class TestMathFunctions(unittest.TestCase):
    ...
    def test_validate_rectangle(self):
        ...
        self.assertFalse(MathUtil.is_rectangle(0, 0, 1, 0, 1, 2, 0, 1))
...
class TestCartesian2Axis(unittest.TestCase):
    ...
    def test_calculate_tick_spacing(self):
        ...
        # The relative width is the width divided by the scale factor, which is 1000 / 2 = 500.
        # The ideal tick spacing is the relative width divided by max_ticks, which is 500 / 10 = 50.
        # The order of magnitude of the ideal tick spacing is 10^1 = 10.
