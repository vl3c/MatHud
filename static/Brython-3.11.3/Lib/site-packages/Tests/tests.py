...
class TestFunction(unittest.TestCase):
    ...
    def test_caching_mechanism(self):
        ...
        self.function._cached_points = None
        self.function._cache_valid = False
        
        # First draw should generate points
        points = self.function._generate_values()
        self.function._cached_points = points
        self.function._cache_valid = True
        initial_points = self.function._cached_points
    ...
    def test_cache_invalidation_on_zoom(self):
        ...
        new_points = self.function._generate_values()
        self.function._cached_points = new_points
    ...
    def test_adaptive_step_size(self):
        ...
        steep_points = steep_function._generate_values()
        gradual_points = gradual_function._generate_values()
    ...
    def test_discontinuity_handling(self):
        ...
        points = discontinuous_function._generate_values()
        ...
        for i in range(1, len(points)):
            ...
            if abs(original_p2.x - original_p1.x) > discontinuous_function.step * 2:
    ...
    def test_draw_with_empty_points(self):
        ...
        original_generate = self.function._generate_values
        self.function._generate_values = lambda: []
        
        # Should not raise error when drawing with no points
        self.function.draw()
        
        # Restore original method
        self.function._generate_values = original_generate
    ...
    def test_deepcopy_with_cache(self):
        ...
        self.assertIsNone(function_copy._cached_points)
    ...
    def test_performance_limits(self):
        ...
        points = complex_function._generate_values()
