...
from math_geometry import Segment, Vector
import copy
import json
import unittest
...
class TestMathFunctions(unittest.TestCase):
    ...
    def test_get_triangle_area(self):
        ...
        p2 = Point(1, 0)
        p3 = Point(0, 1)
        self.assertAlmostEqual(MathUtil.get_triangle_area(MathUtil, p1, p2, p3), 0.5)
...
class TestPoint(unittest.TestCase):
    ...
    def test_translate_towards(self):
        ...
        self.assertAlmostEqual(round(self.point.y, 5), -1.02986, places=5)

    def test_zoom(self):
        self.point.zoom()
        self.assertAlmostEqual(self.point.x, 1.0, places=4)
        self.assertAlmostEqual(self.point.y, -1.7, places=4)

    def test_pan(self):
        self.point.pan()
        self.assertEqual(self.point.x, 1.5)
        self.assertEqual(self.point.y, -1.5)
...
class TestSegment(unittest.TestCase):
    ...
    def test_initialize(self):
        ...
        self.assertEqual(self.segment.point2.y, -4)  # Assuming coordinate system adjustments
    ...
    def test_translate(self):
        ...
        self.assertEqual(self.segment.point1.y, 1)
        self.assertEqual(self.segment.point2.x, 4)
        self.assertEqual(self.segment.point2.y, -3)
