"""
MatHud Hexagon Geometric Object

Represents a six-sided polygon composed of six connected segments. Validates the
...
class Hexagon(Polygon):
    ...
    def __deepcopy__(self, memo: Dict[int, Any]) -> Hexagon:
        if id(self) in memo:
