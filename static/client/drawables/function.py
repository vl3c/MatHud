...
class Function(Drawable):
    ...
    def _generate_paths(self):
        ...
        while x <= right_bound + step:
            ...
            # If the vertical pixel jump is huge, break path at discontinuity/asymptote
            pixel_jump = abs(neighbor_prev_scaled_point.y - scaled_point.y)
            if pixel_jump > self.canvas.cartesian2axis.height * 2:
