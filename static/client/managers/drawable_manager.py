...
class DrawableManager:
    ...
    def get_drawables(self) -> List["Drawable"]:
        ...
        return self.drawables.get_all_with_layering()
    
    # ------------------- Point Methods -------------------
    
    def get_point(self, x: float, y: float) -> Optional[Any]:  # Point
        """Get a point at the specified coordinates"""
        return self.point_manager.get_point(x, y)
        
    def get_point_by_name(self, name: str) -> Optional[Any]:  # Point
        """Get a point by its name"""
        return self.point_manager.get_point_by_name(name)
        
    def create_point(self, x: float, y: float, name: str = "", extra_graphics: bool = True) -> Any:  # Point
    ...
    def get_segment_by_coordinates(self, x1: float, y1: float, x2: float, y2: float) -> Optional[Any]:  # Segment
        """Get a segment by its endpoint coordinates"""
        return self.segment_manager.get_segment_by_coordinates(x1, y1, x2, y2)
        
    def get_segment_by_name(self, name: str) -> Optional[Any]:  # Segment
        """Get a segment by its name"""
        return self.segment_manager.get_segment_by_name(name)
        
    def get_segment_by_points(self, p1: Point, p2: Point) -> Optional[Any]:  # Segment
        """Get a segment by its endpoint points"""
        return self.segment_manager.get_segment_by_points(p1, p2)
        
    def create_segment(self, x1: float, y1: float, x2: float, y2: float, name: str = "", extra_graphics: bool = True) -> Any:  # Segment
    ...
    def get_vector(self, origin_x: float, origin_y: float, tip_x: float, tip_y: float) -> Optional[Any]:  # Vector
        """Get a vector by its origin and tip coordinates"""
        return self.vector_manager.get_vector(origin_x, origin_y, tip_x, tip_y)
        
    def create_vector(self, origin_x: float, origin_y: float, tip_x: float, tip_y: float, name: str = "", extra_graphics: bool = True) -> Any:  # Vector
    ...
    def get_triangle(self, x1: float, y1: float, x2: float, y2: float, x3: float, y3: float) -> Optional[Any]:  # Triangle
        """Get a triangle by its vertex coordinates"""
        return self.triangle_manager.get_triangle(x1, y1, x2, y2, x3, y3)
        
    def create_triangle(self, x1: float, y1: float, x2: float, y2: float, x3: float, y3: float, name: str = "", extra_graphics: bool = True) -> Any:  # Triangle
    ...
    def get_function(self, name: str) -> Optional[Any]:  # Function
        """Get a function by its name"""
        return self.function_manager.get_function(name)
        
    def draw_function(self, function_string: str, name: str, left_bound: Optional[float] = None, right_bound: Optional[float] = None) -> Any:  # Function
    ...
    def get_circle(self, center_x: float, center_y: float, radius: float) -> Optional[Any]:  # Circle
        """Get a circle by its center coordinates and radius"""
        return self.circle_manager.get_circle(center_x, center_y, radius)
        
    def get_circle_by_name(self, name: str) -> Optional[Any]:  # Circle
        """Get a circle by its name"""
        return self.circle_manager.get_circle_by_name(name)
        
    def create_circle(self, center_x: float, center_y: float, radius: float, name: str = "", extra_graphics: bool = True) -> Any:  # Circle
    ...
    def get_ellipse(self, center_x: float, center_y: float, radius_x: float, radius_y: float) -> Optional[Any]:  # Ellipse
    ...
    def get_ellipse_by_name(self, name: str) -> Optional[Any]:  # Ellipse
        """Get an ellipse by its name"""
        return self.ellipse_manager.get_ellipse_by_name(name)
        
    def create_ellipse(self, center_x: float, center_y: float, radius_x: float, radius_y: float, rotation_angle: float = 0, name: str = "", extra_graphics: bool = True) -> Any:  # Ellipse
    ...
    def get_rectangle_by_diagonal_points(self, px: float, py: float, opposite_px: float, opposite_py: float) -> Optional[Any]:  # Rectangle
    ...
    def get_rectangle_by_name(self, name: str) -> Optional[Any]:  # Rectangle
        """Get a rectangle by its name"""
        return self.rectangle_manager.get_rectangle_by_name(name)
        
    def create_rectangle(self, px: float, py: float, opposite_px: float, opposite_py: float, name: str = "", extra_graphics: bool = True) -> Any:  # Rectangle
    ...
    def create_colored_area(self, drawable1_name: str, drawable2_name: Optional[str] = None, left_bound: Optional[float] = None, right_bound: Optional[float] = None, color: str = "lightblue", opacity: float = 0.3) -> Any:  # ColoredArea
    ...
    def create_angle(self, vx: float, vy: float, p1x: float, p1y: float, p2x: float, p2y: float, color: Optional[str] = None, angle_name: Optional[str] = None, is_reflex: bool = False, extra_graphics: bool = True) -> Optional[Any]:  # Angle
    ...
    def delete_angle(self, name: str) -> bool:
        ...
        return self.angle_manager.delete_angle(name)
    ...
    def update_angle_properties(self, name: str, new_label: Optional[str] = None, new_color: Optional[str] = None) -> bool:
        ...
        return self.angle_manager.update_angle_properties(name, new_label, new_color) 