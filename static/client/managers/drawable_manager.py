...
class DrawableManager:
    ...
    def create_angle(self, vx, vy, p1x, p1y, p2x, p2y, color=None, angle_name=None, is_reflex=False, extra_graphics=True):
    ...
    def update_angle_properties(self, name, new_label=None, new_color=None):
